...
const DevelopmentServicesSection: React.FC = () => {
  ...
  const developmentServices = [
    { icon: '⚡', title: 'Web Development', description: 'Custom websites and web applications' },
    { icon: '📱', title: 'Mobile Development', description: 'Native and cross-platform mobile apps' },
    { icon: '🔧', title: 'API Development', description: 'RESTful and GraphQL API solutions' },
